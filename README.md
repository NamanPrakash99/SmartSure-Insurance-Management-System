...
- **🛡️ Policy Service**: Manages insurance policies, including creation, updates, and retrieval.
...
- **⚙️ Config Server**: Centralized configuration management across all environments.

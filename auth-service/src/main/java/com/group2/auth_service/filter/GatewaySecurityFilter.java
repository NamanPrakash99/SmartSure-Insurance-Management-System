...
public class GatewaySecurityFilter extends OncePerRequestFilter {
    ...
    private static final String AUTH_GATEWAY_HEADER = "X-Gateway-Secret";
    private static final String AUTH_GATEWAY_TOKEN = "SmartSureSecretKey2026";
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        String secret = request.getHeader(AUTH_GATEWAY_HEADER);
        if (secret != null && secret.contains(AUTH_GATEWAY_TOKEN)) {
            filterChain.doFilter(request, response);
        } else {

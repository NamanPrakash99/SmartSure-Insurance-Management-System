...
public class GatewaySecurityFilter extends OncePerRequestFilter {
    ...
    private static final String CLAIMS_GATEWAY_HEADER = "X-Gateway-Secret";
    private static final String CLAIMS_AUTH_VALUE = "SmartSureSecretKey2026";
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        String secret = request.getHeader(CLAIMS_GATEWAY_HEADER);
        if (secret != null && secret.contains(CLAIMS_AUTH_VALUE)) {
            filterChain.doFilter(request, response);
        } else {

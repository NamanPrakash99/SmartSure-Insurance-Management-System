...
import { HiOutlinePencilAlt, HiOutlineTrash, HiOutlinePlus, HiSearch, HiOutlineSparkles } from 'react-icons/hi'
...
export default function PolicyManagement() {
  ...
  const handleOpenEdit = (policy) => {
    ...
    setFormData({
      ...
      // The backend DTO doesn't return policyTypeId in PolicyResponseDTO natively unless mapped, 
      // but assuming it does or defaulting if undefined:
  ...
  return (
    <div className="space-y-10">
      {/* Premium AI-Style Header Overlay */}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {/* Pagination Toolbar */}
      <div className="card-glass p-4 mt-8 flex flex-row items-center justify-between relative overflow-hidden">
           {/* LEFT: Previous */}
           <button 
